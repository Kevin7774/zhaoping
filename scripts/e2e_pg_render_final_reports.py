...
def main() -> None:
    ...
    common = {
        ...
        "frontendEntryStatus": "legacy JSX workbench removed; TS router entry is the only frontend entry",
    ...
    bugs_fixed = [
        ...
        "Error-probe stale assertion: topbar project switcher legitimately shows project names from GET /projects; detail-only assertions are required.",
    ...
    v_hanno = {
        **common,
        ...
        "noFakeJobs": "jobs generated by the five-stage BP pipeline from the BP document and persisted in PG; titles match BP domain",
        "privacy": {
