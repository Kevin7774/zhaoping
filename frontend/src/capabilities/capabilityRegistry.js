...
export const PATH_PRODUCTIZATION = {
  ...
  '/projects/{project_id}/materials/upload': 'productized',
...
export const CAPABILITY_REGISTRY = [
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: 'materialFile', label: '项目材料文件', type: 'file', required: false },
      { name: 'bpFilePath', label: '解析后材料路径', type: 'text', required: false },
