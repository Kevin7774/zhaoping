      ...
      jsonResponse([
        {
          ...
          githubUrl: "https://github.com/linchen",
          linkedinUrl: "https://www.linkedin.com/in/linchen",
          homepageUrl: "https://linchen.dev",
    ...
    expect(JSON.parse(init.body as string)).toMatchObject({
      ...
      frontend_state: {
        ...
        source_layers: {
          ...
          due_diligence: false,
          financial_regulatory: false,
          healthcare_regulatory: false,
    ...
    await runProjectScenario("project_2026_ai_team", job, "find_candidates", {
      searchConfig: {
        ...
        sourceLayers: {
          ...
          dueDiligence: true,
          financialRegulatory: true,
          healthcareRegulatory: true,
          safetyEnvironment: true,
          publicFunding: true,
        },
        budget: {
          maxProviders: 8,
